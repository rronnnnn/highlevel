      ...
      style={
        {
          ...
          "--ow-inset": `${inset}px`,
          // only trap the gesture for drag-to-scroll when dragging is actually
          // enabled — otherwise a touch swipe here must fall through as normal
          // page scroll instead of getting stuck spinning the wheel
